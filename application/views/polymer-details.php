...
<div class="inner-pages-bnr">
    ...
    <div class="banner-caption">
        <h1><?= $record->PloymerTitle ?></h1>
        <ul class="breadcumb">
            <li><a href="#">Home</a> - </li>
            <li><?= $record->PloymerTitle ?></li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="blog-list-cl ">
                    ...
                    <div class="blog-head">
                        <h6 class="wdt-100"><?= $record->PloymerTitle ?></h6>
                    </div>
                ...
                <div class="wdt-100 marbtm50">
                    ...
                    <?php foreach ($recent as $row) : ?>
                        <div class="post-list">
                            ...
                            <div class="post-txt">
                                <h5><?= $row->PloymerTitle ?></h5>
                                <a class="read-more" href="<?= base_url('Ploymer-Details/') . url_title($row->PloymerTitle) . '/' . $row->PloymerId ?>">Read More</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
