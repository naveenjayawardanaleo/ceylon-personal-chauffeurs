...
<div class="inner-pages-bnr">
    ...
    <div class="banner-caption">
        <h1><?= $record->PantryTitle ?></h1>
        <ul class="breadcumb">
            <li><a href="#">Home</a> - </li>
            <li><?= $record->PantryTitle ?></li>
        </ul>
    </div>
</div>
<!--=========Banner end============-->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="blog-list-cl ">
                    ...
                    <div class="blog-head">
                        <h6 class="wdt-100"><?= $record->PantryTitle ?></h6>
                    </div>
                    ...
                    <?php foreach ($recent as $row) : ?>
                        <div class="post-list">
                            ...
                            <div class="post-txt">
                                ...
                                <a class="read-more" href="<?= base_url('Pantry-Details/') . url_title($row->PantryTitle) . '/' . $row->PantryId ?>">Read More</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
