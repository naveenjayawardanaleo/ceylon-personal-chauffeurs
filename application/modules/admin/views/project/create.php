                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Project/form/<?= $obj->ProjectId ?>">
                                <div class="row">
                                    <div class="col-md-8">

                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Type of Tour</label>
                                            <select class="form-control" name="form[TourType]">
                                                <option value="1" <?= $obj->TourType == 1 ? 'selected' : '' ?>>Day Tours</option>
                                                <option value="2" <?= $obj->TourType == 2 ? 'selected' : '' ?>>Multiple Day Tours</option>
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <label for="ProjectTitle">Project Title</label>
                                            <input type="text" value="<?= $obj->ProjectTitle ?>" name="form[ProjectTitle]" class="form-control" id="ProjectTitle" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Days</label>
                                                    <input type="number" value="<?= $obj->days ?>" name="form[Days]" class="form-control" id="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Nights</label>
                                                    <input type="number" value="<?= $obj->nights ?>" name="form[Nights]" class="form-control" id="" required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Default Image <small>(1024px X 615px)</small></label><br>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="summernote" name="form[Description]" id="kt_summernote_1"><?= $obj->Description ?></textarea>
                                        </div>
                                    </div>
