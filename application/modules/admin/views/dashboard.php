        ...
        <div class=" container ">
            ...
            <div class="row">
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div style="display: none;" class="card card-custom bg-gray-100 card-stretch gutter-b">
                        <!--begin::Header-->
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                                        <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Urgent-mail.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <!--begin::List Widget 9-->
                    <div style="display: none;" class="card card-custom card-stretch gutter-b">
                        <!--begin::Header-->
                ...
                <div style="display: none;" class="col-lg-6 col-xxl-4">
                ...
                <div style="display: none;" class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
                    <!--begin::List Widget 1-->
                ...
                <div style="display: none;" class="col-xxl-8 order-2 order-xxl-1">
                ...
                <div style="display: none;" class="col-lg-6 col-xxl-4 order-1 order-xxl-2">
                    <!--begin::List Widget 3-->
                    <div class="card card-custom card-stretch gutter-b">
                        <!--begin::Header-->
                ...
                <div style="display: none;" class="col-lg-12 col-xxl-4 order-1 order-xxl-2">
                    <!--begin::List Widget 8-->
                    <div class="card card-custom card-stretch gutter-b">
                        <!--begin::Header-->
                        <div class="card-header border-0">
