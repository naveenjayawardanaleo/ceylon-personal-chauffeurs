                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label for="BrandTitle">Title 1</label>
                                            <input type="text" value="<?= $obj->Title1 ?>" name="form[Title1]" class="form-control" id="BrandTitle" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="BrandTitle">Title 2</label>
                                            <input type="text" value="<?= $obj->Title2 ?>" name="form[Title2]" class="form-control" id="BrandTitle" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="BrandTitle">Title 3</label>
                                            <input type="text" value="<?= $obj->Title3 ?>" name="form[Title3]" class="form-control" id="BrandTitle" required>
                                        </div>
                                        <!-- <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Default Image <small>(1600px X 838px)</small></label><br>
                                    ...
                                    <!-- <div class="col-md-12" style="display: none;">
                                        <div>
                                            <label>More Images <small>(236pxX 56px)</small></label>
                                            <div class="row ">
                                                <div class="fileinput-button btn btn-primary  btn-upload-primary sepH_b">
                                                    <span>Upload</span>
